...
import 'concierge_services_screen.dart';
...
final List<_CategoryItem> categories = [
  _CategoryItem("Physical Security", "physical_security.png"),
  _CategoryItem("Secured Mobility", "secured_mobility.png"),
  _CategoryItem("Outsourcing & Talent Risk", "outsourcing.png"),
  _CategoryItem(
    "Digital Security & Privacy Protection",
    "digital_security.png",
  ),
  _CategoryItem("Concierge Services", "concierge_services.png"),
  _CategoryItem("Also By Halogen", "logocut.png"),
];
