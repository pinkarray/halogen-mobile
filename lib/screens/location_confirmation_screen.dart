...
class _LocationConfirmationScreenState extends State<LocationConfirmationScreen> {
  ...
  void initState() {
    ...
    if (siteData != null && siteData['confirmed_map_address'] != null) {
      _addressController.text = siteData['confirmed_map_address'];
      isAddressValid = true;
    }
  ...
  void _completeConfirmation() {
    ...
    final existing = provider.allSections['site_inspection'] ?? {};

    provider.updateSection('site_inspection', {
      ...existing,
      'confirmed_map_address': _addressController.text.trim(),
    });
