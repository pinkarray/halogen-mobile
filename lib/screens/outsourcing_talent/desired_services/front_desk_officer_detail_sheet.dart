...
class FrontDeskOfficerDetailSheet extends StatefulWidget {
  ...
  const FrontDeskOfficerDetailSheet({super.key, required this.onSaved});
...
class _FrontDeskOfficerDetailSheetState extends State<FrontDeskOfficerDetailSheet> {
  ...
  void initState() {
    ...
    final data = context.read<UserFormDataProvider>()
        .allSections['outsourcing_talent']?['desired_services']?['business_staff']?['front_desk_officer'] ?? {};
  ...
  void _saveSelection() {
    ...
    if (roleData.isNotEmpty) {
      businessStaff['front_desk_officer'] = roleData;
