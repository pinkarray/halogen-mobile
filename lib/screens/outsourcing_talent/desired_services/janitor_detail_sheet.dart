...
class JanitorDetailSheet extends StatefulWidget {
  final VoidCallback onSaved;

  const JanitorDetailSheet({super.key, required this.onSaved});

  @override
  State<JanitorDetailSheet> createState() => _JanitorDetailSheetState();
}

class _JanitorDetailSheetState extends State<JanitorDetailSheet> {
  ...
  void initState() {
    ...
    final data = context.read<UserFormDataProvider>()
        .allSections['outsourcing_talent']?['desired_services']?['business_staff']?['janitor'] ?? {};
  ...
  void _saveSelection() {
    ...
    if (roleData.isNotEmpty) {
      businessStaff['janitor'] = roleData;
