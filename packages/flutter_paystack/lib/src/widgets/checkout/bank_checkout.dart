...
class BankCheckout extends StatefulWidget {
  ...
  @override
  BankCheckoutState createState() => BankCheckoutState();
}

class BankCheckoutState extends BaseCheckoutMethodState<BankCheckout> {
  ...
  BankCheckoutState() : super( CheckoutMethod.bank);
    ...
    return Form(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          _currentBank == null
              ? const Icon(Icons.account_balance, size: 35.0)
