...
class CheckoutWidgetState extends BaseState<CheckoutWidget>
  ...
  Widget buildCheckoutMethods(Color accentColor) {
    return AnimatedSize(
      ...
      child: Container(
        color: context.colorScheme().surface.withValues(alpha: (0.5 * 255).roundToDouble()),
        height: _tabHeight,
...
typedef OnResponse = void Function(CheckoutResponse response);